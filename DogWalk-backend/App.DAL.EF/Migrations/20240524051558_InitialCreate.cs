    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DogName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartingAddress = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersDogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersDogs_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersDogs_Dogs_DogId",
                        column: x => x.DogId,
                        principalTable: "Dogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetStartingTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WalkId = table.Column<Guid>(type: "uuid", nullable: false),
                    DogId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DogInWalks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DogInWalks_Dogs_DogId",
                        column: x => x.DogId,
                        principalTable: "Dogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DogInWalks_Walks_WalkId",
                        column: x => x.WalkId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserInWalks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserInWalks_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInWalks_Walks_WalkId",
                        column: x => x.WalkId,
                        principalTable: "Walks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WalkOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WalkOffers_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WalkOffers_Walks_WalkId",
                        column: x => x.WalkId,
                        principalTable: "Walks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserInWalkId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageBoxes_UserInWalks_UserInWalkId",
                        column: x => x.UserInWalkId,
                        principalTable: "UserInWalks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DogInWalks_DogId",
                table: "DogInWalks",
                column: "DogId");

            migrationBuilder.CreateIndex(
                name: "IX_DogInWalks_WalkId",
                table: "DogInWalks",
                column: "WalkId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageBoxes_UserInWalkId",
                table: "MessageBoxes",
                column: "UserInWalkId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInWalks_AppUserId",
                table: "UserInWalks",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInWalks_WalkId",
                table: "UserInWalks",
                column: "WalkId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersDogs_AppUserId",
                table: "UsersDogs",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersDogs_DogId",
                table: "UsersDogs",
                column: "DogId");

            migrationBuilder.CreateIndex(
                name: "IX_WalkOffers_AppUserId",
                table: "WalkOffers",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_WalkOffers_WalkId",
                table: "WalkOffers",
                column: "WalkId");
